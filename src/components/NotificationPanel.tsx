													...
													<div className="flex items-start space-x-3">
														...
														<div className="flex-1 min-w-0">
															<div className="flex items-start justify-between">
																<div className="flex-1">
																	...
																	<div className="flex items-center justify-between mt-2">
																		...
																		{!isReplying ? (
																			<motion.button className="text-xs text-primary font-medium cursor-pointer" whileHover={{ scale: 1.05 }} onClick={(e: React.MouseEvent) => handleStartReply(e, n.id)}>Reply</motion.button>
																		) : null}
																	</div>
																	{isReplying ? (
															...
															<div className="flex items-center space-x-1 ml-2">
																{!n.isRead && (
																	<motion.button onClick={(e: React.MouseEvent) => { e.stopPropagation(); markAsRead(n.id); }} className="p-1 text-muted-foreground hover:text-foreground opacity-0 group-hover:opacity-100 transition-opacity" whileHover={{ scale: 1.2 }} title="Mark as read">
																		<Check className="w-3 h-3" />
																	</motion.button>
																)}
																<motion.button onClick={(e: React.MouseEvent) => { e.stopPropagation(); removeNotification(n.id); }} className="p-1 text-muted-foreground hover:text-red-500 opacity-0 group-hover:opacity-100 transition-opacity" whileHover={{ scale: 1.2 }} title="Dismiss">
																	<X className="w-3 h-3" />
																</motion.button>
														</div>
														</div>
