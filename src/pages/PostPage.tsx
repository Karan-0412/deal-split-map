  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const requestData = {
        ...
        people_required: parseInt(formData.peopleRequired) || 2,
        user_id: user.id,
        status: 'active'
      };
              ...
              <Card className="glass-card">
                ...
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      <Label htmlFor="peopleRequired">People Required (including yourself) *</Label>
                      <Input
                        id="peopleRequired"
                        type="number"
                        min="2"
                        ...
                        onChange={(e) => handleInputChange('peopleRequired', e.target.value)}
                        required
                      />
                      <p className="text-sm text-muted-foreground mt-1">
                        Minimum 2 people (including yourself) for group deals
                      </p>
                    </div>
